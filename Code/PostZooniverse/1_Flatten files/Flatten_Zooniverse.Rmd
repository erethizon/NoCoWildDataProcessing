...
flatten_subjects has some problems since it is customized for there being particular pieces of information in the manifest. I need to tweak it so that it let's you customize what it returns.
