...
jdata<-choose_my_class_file(class_file_path)
```
...
library(tidyverse)
summary(data)
data_summary<-my_example %>% group_by(subject_ids) %>% summarise(
...
Why when I run this is flat_file showing 419 fewer rows than data?
