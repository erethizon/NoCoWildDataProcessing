...
write file
```{r}
write.csv(filesToCheck, here("Output","PostZooniverse", "master_files_to_check-2023-06-13.csv"))
```
...
Checklist<-data.frame(subject_ids = integer(length(Subjects)),
                      ...
                      SD_card = integer(length(Subjects)))
```
Now loop
```{r}
...
```{r}
write.csv(Assigned, here("Output", "PostZooniverse", "AssignedSpecies_through_2023-06-13.csv"))
```
