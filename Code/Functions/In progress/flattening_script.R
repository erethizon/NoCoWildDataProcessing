##this is the file from Ali Burchard's github account in the DataProcessing folder


#library(tidyjson) Needs to be commented out since tidyjson not available
library(magrittr)
library(jsonlite)
library(dplyr)
library(stringr)
